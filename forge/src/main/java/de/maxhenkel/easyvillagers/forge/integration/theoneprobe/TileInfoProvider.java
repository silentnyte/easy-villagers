package de.maxhenkel.easyvillagers.forge.integration.theoneprobe;
...
import de.maxhenkel.easyvillagers.forge.blocks.tileentity.VillagerTileentity;
...
public class TileInfoProvider implements IProbeInfoProvider {
    ...
    public static final ResourceLocation ID = new ResourceLocation(EasyVillagers.MOD_ID, "probeinfoprovider");
