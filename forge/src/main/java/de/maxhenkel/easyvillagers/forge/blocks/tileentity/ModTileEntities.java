...
import de.maxhenkel.easyvillagers.forge.blocks.tileentity.render.*;
...
public class ModTileEntities {
    ...
    public static void registerTileEntities(RegistryEvent.Register<BlockEntityType<?>> event) {
        ...
        TRADER.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "trader"));
        ...
        CONVERTER.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "converter"));
        ...
        IRON_FARM.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "iron_farm"));
        ...
        INCUBATOR.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "incubator"));
