...
public class Containers {
    ...
    public static void registerContainers(RegistryEvent.Register<MenuType<?>> event) {
        ...
        AUTO_TRADER_CONTAINER.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "auto_trader"));
        event.getRegistry().register(AUTO_TRADER_CONTAINER);

        BREEDER_CONTAINER = new MenuType<>(BreederContainer::new);
        BREEDER_CONTAINER.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "breeder"));
        event.getRegistry().register(BREEDER_CONTAINER);

        VILLAGER_IO_CONTAINER = new MenuType<>(VillagerIOContainer::new);
        VILLAGER_IO_CONTAINER.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "converter"));
        event.getRegistry().register(VILLAGER_IO_CONTAINER);

        OUTPUT_CONTAINER = new MenuType<>(OutputContainer::new);
        OUTPUT_CONTAINER.setRegistryName(new ResourceLocation(EasyVillagers.MOD_ID, "output"));
