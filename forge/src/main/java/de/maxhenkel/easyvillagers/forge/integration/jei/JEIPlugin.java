package de.maxhenkel.easyvillagers.forge.integration.jei;
...
import de.maxhenkel.easyvillagers.forge.integration.jei.breeder.BreederCategory;
import de.maxhenkel.easyvillagers.forge.integration.jei.converter.ConverterCategory;
import de.maxhenkel.easyvillagers.forge.integration.jei.incubator.IncubatorCategory;
...
public class JEIPlugin implements IModPlugin {
    ...
    public static final ResourceLocation CATEGORY_BREEDING = new ResourceLocation(EasyVillagers.MOD_ID, "breeding");
    public static final ResourceLocation CATEGORY_CONVERTING = new ResourceLocation(EasyVillagers.MOD_ID, "converting");
    public static final ResourceLocation CATEGORY_INCUBATING = new ResourceLocation(EasyVillagers.MOD_ID, "incubating");

    @Override
    public ResourceLocation getPluginUid() {
        return new ResourceLocation(EasyVillagers.MOD_ID, "easy_villagers");
    }
