...
//FIXME import net.minecraftforge.items.ItemHandlerHelper;
...
public class ItemUtils {
    ...
    public static boolean isStackable(ItemStack stack1, ItemStack stack2) {
        return canItemStacksStack(stack1, stack2);
    }
    ...
    public static boolean canItemStacksStack(@NotNull ItemStack a, @NotNull ItemStack b)
    {
        ...
        return (!a.hasTag() || a.getTag().equals(b.getTag())); //FIXME && a.areCapsCompatible(b);
    }
